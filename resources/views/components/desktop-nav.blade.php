    ...
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                ...
                <li>
                    ...
                    <a href="{{ route('home') }}"
                       @class([
                            ...
                            'bg-gray-800 text-white' => request()->routeIs('home'),
                            'text-gray-400 hover:text-white hover:bg-gray-800' => ! request()->routeIs('home'),
                        ])
                    >
        ...
        <li>
            ...
            <li class="-mx-6 mt-auto">
                <a  href="{{ route('dashboard') }}" class="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-gray-800">
            ...
            @else
            <li class="-mx-6 mt-auto flex justify-evenly">
